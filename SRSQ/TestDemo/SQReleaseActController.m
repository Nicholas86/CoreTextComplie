...
- (void)releaseAct {
    ...
    void(^sendActBlock)(NSArray *) = ^(NSArray *urlArr){
        ...
        NSDictionary *dict = @{
                               @"account": @"qq149482454700WHRo-dwG-feZ7naYPIQqQw",//[SQUser sharedUser].account,
                               @"token": @"149482454717gKC6Uo8cLtlYY5KEt7Lw4A",//[SQUser sharedUser].token,
                               @"actcontent": self.textView.fullText,
                               @"acttime": num,
                               @"commoncount": @(0),
                               @"headimgurl": @"http:\/\/olt49m07v.bkt.clouddn.com\/20170515130624281.jpg",//[SQUser sharedUser].headimgurl,
                               @"photostr": photos,
                               @"sex": @"1",//[SQUser sharedUser].sex,
                               @"sqlocal": self.city ? self.city : @"未知",
                               @"username": @"锋.",//[SQUser sharedUser].username,
                               @"zancount": @(0),
                               @"rcuserid": @"2017051513022633833347",//[SQUser sharedUser].rcuserid,
                               @"width" : @(imgWH.width),
                               @"height" : @(imgWH.height)
                               };
