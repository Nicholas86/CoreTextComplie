...
/*
 showLoginInfoState:user:userThirdType:error:btn:] [Line 261] 登陆成功
 2017-08-31 15:27:17.374 私人社区[43034:470913] +[CYNetworkManager postRequestWithURL:params:success:faildBlock:]_block_invoke [Line 183]
 请求参数->{
	username : 锋.,
	sex : 1,
	headimgurl : http://qzapp.qlogo.cn/qzapp/1105477680/0F58F230169BDD71D09E69418256DEF4/100,
	deviceno : 79a4f65c40868101f662d5b456ecd904,
	way : qq,
...
- (void)viewDidLoad {
    ...
    self.tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        [weakSelf loadBannerArray]; //请求轮播图数据
        
        [weakSelf loadDataArray]; //请求列表数据
        
    }];
    
    [self.tableView.mj_header beginRefreshing]; //进入页面立即刷新
